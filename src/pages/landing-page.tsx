                ...
                >
                    <Grid>
                        ...
                        <Grid.Col span={{ xs: 12, md: 2 }}>
                            <Stack gap={10}>
                                <Image
                                    src="assets/MosaiqLogoTransparent.png"
                                    alt="Mosaiq Logo"
                                    w={50}
                                    h={50}
                                    mx="auto"
                        ...
                        <Grid.Col span={{ xs: 0, md: 5 }}></Grid.Col>
                        <Grid.Col span={12}>
                            <Text
                                ta="center"
                                size="2.33rem"
                        ...
                        <Grid.Col span={12}>
                            <Text
                                ...
                                size="xl"
                            >
                                Build real-world software and boost your future
                            </Text>
                        </Grid.Col>
                        <Grid.Col span={12}>
                            <Group
                        ...
                        <Grid.Col span={12}>
                            <Title
                                ...
                                py="lg"
                            >
                                What You’ll Do as a Mosaiq Member
                            </Title>
                        ...
                        <Grid.Col span={12}>
                            ...
                            <Text
                                ...
                                ta="center"
                            >
                                Questions? Email us at <a href={`mailto:${process.env.EMAIL}`}>{process.env.EMAIL}</a>
                            </Text>
                        </Grid.Col>
                        <Grid.Col span={12}>
                            <Group
